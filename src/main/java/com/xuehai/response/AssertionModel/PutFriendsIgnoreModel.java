...
/**
 * @Author slyart
 * @create 2019/8/13 3:57 PM
 */
public class PutFriendsIgnoreModel {

    /**
     * responseCode : 204
     * responseMessage :
     * responseHeader : {"X-Content-Type-Options":"nosniff","X-XSS-Protection":"1; mode=block","Cache-Control":"no-cache, no-store, max-age=0, must-revalidate","Pragma":"no-cache","Expires":"0","X-Frame-Options":"DENY","Date":"Tue, 13 Aug 2019 06:47:50 GMT"}
     * responseInfo : null
     */
