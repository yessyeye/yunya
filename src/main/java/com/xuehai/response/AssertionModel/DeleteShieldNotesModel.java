...
/**
 * @Author slyart
 * @create 2019/8/18 11:15 AM
 */
public class DeleteShieldNotesModel {

    /**
     * responseCode : 204
     * responseMessage :
     * responseHeader : {"X-Content-Type-Options":"nosniff","X-XSS-Protection":"1; mode=block","Cache-Control":"no-cache, no-store, max-age=0, must-revalidate","Pragma":"no-cache","Expires":"0","X-Frame-Options":"DENY","Date":"Sun, 18 Aug 2019 00:55:27 GMT"}
     * responseInfo : null
     */
    ...
    public static class ResponseHeaderBean {
         ...
         * Date : Sun, 18 Aug 2019 00:55:27 GMT
         */
