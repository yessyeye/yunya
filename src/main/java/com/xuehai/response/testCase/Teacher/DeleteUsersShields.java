...
/**
 * @Author slyart
 * @create 2019/5/29 1:27 PM
 */
public class DeleteUsersShields extends BaseTest {
    Log logger = new Log(DeleteUsersShields.class);
    ...
    @Test(dataProvider = "data", description = "取消屏蔽对方")
