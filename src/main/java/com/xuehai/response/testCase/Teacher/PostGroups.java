...
/**
 * @Author slyart
 * @create 2019/5/28 8:26 PM
 */
public class PostGroups extends BaseTest {
    Log logger = new Log(PostGroups.class);
    private static HashMap<String, AssertHandler> assertMap = new HashMap<String, AssertHandler>();

    static {
        assertMap.put("first", new PostGroupsAssertion());
    }
    ...
    @Test(dataProvider = "data", description = "创建群组")
