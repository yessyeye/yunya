...
import com.xuehai.response.Assertion.DeleteShieldNotesAssertion;
...
/**
 * @Author slyart
 * @create 2019/5/29 10:52 AM
 */
public class DeleteShieldNotes extends BaseTest {
    Log logger = new Log(DeleteShieldNotes.class);
    private static HashMap<String, AssertHandler> assertMap = new HashMap<String, AssertHandler>();

    static {
        assertMap.put("first", new DeleteShieldNotesAssertion());
    }
