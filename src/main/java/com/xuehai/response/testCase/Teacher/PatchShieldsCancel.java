...
import com.xuehai.response.Assertion.PatchShieldsCancelAssertion;
...
/**
 * @Author slyart
 * @create 2019/5/30 7:12 PM
 */
public class PatchShieldsCancel extends BaseTest {
    Log logger = new Log(PatchShieldsCancel.class);
    private static HashMap<String, AssertHandler> assertMap = new HashMap<String, AssertHandler>();

    static {
        assertMap.put("first", new PatchShieldsCancelAssertion());
    }
