...
import com.xuehai.response.Assertion.PutGroupsSilenceAssertion;
...
/**
 * @Author slyart
 * @create 2020/6/10 2:30 PM
 */
public class PutGroupsSilence extends BaseTest {
    Log logger = new Log(PutGroupsSilence.class);
    private static HashMap<String, AssertHandler> assertMap = new HashMap<String, AssertHandler>();

    static {
        assertMap.put("first", new PutGroupsSilenceAssertion());
    }
    ...
    @Test(dataProvider = "data", description = "增加或删除用户禁言")
