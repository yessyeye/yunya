...
import com.xuehai.response.Assertion.PostShieldNotesAssertion;
...
/**
 * @Author slyart
 * @create 2019/5/29 10:40 AM
 */
public class PostShieldNotes extends BaseTest {
    Log logger = new Log(PostShieldNotes.class);
    private static HashMap<String, AssertHandler> assertMap = new HashMap<String, AssertHandler>();

    static {
        assertMap.put("first", new PostShieldNotesAssertion());
    }
