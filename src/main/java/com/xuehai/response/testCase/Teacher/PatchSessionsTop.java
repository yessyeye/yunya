...
/**
 * @Author slyart
 * @create 2019/5/27 1:57 PM
 */
public class PatchSessionsTop extends BaseTest{
    Log logger = new Log(PatchSessionsTop.class);
    ...
    @Test(dataProvider = "data", description = "置顶会话")
