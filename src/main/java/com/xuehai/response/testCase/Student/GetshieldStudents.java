...
import com.xuehai.response.Assertion.GetshieldStudentsAssertion;
...
/**
 * @Author slyart
 * @create 2019/6/4 10:44 AM
 */
public class GetshieldStudents extends BaseTest {
    Log logger = new Log(GetshieldStudents.class);
    private static HashMap<String, AssertHandler> assertMap = new HashMap<String, AssertHandler>();

    static {
        assertMap.put("first", new GetshieldStudentsAssertion());
    }
    ...
    @Test(dataProvider = "data", description = "学生获取屏蔽他的老师列表")
