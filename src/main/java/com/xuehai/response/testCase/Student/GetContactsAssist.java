...
/**
 * @Author slyart
 * @create 2020/6/5 4:44 PM
 */
public class GetContactsAssist extends BaseTest {
    Log logger = new Log(GetContactsAssist.class);
    ...
    @Test(dataProvider = "data", description = "获取小助手")
